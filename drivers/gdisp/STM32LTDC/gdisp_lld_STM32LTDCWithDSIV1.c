...
#include "../../../boards/base/STM32F769i-Discovery/board_STM32LTDCWithDSI.h"
...
static void _ltdc_init(void) {
	...
	// Enable the LTDC clock
			...
			RCC->DCKCFGR1 = (RCC->DCKCFGR1 & ~RCC_DCKCFGR1_PLLSAIDIVR) | (1 << 16);//See Line 1299 in BSP_LCD_MspInit() @stm32746g_discovery_lcd.c
		#else
