...
static bool_t init_board(GMouse* m, unsigned driverinstance) {
	...
	if (driverinstance)
		return FALSE;
#define I2C_MODE 		PAL_STM32_OTYPE_OPENDRAIN | PAL_STM32_OSPEED_HIGHEST|PAL_STM32_PUPDR_PULLUP
#define I2C_MODE2 	    PAL_STM32_PUPDR_FLOATING
	// Set pin modes
		...
		palSetPadMode(GPIOA, 8, PAL_MODE_ALTERNATE(4) | PAL_STM32_OTYPE_OPENDRAIN | I2C_MODE);	/* SCL */
		palSetPadMode(GPIOC, 9, PAL_MODE_ALTERNATE(4) | PAL_STM32_OTYPE_OPENDRAIN | I2C_MODE);	/* SDA */
	#endif
...
static void write_reg(GMouse* m, uint8_t reg, uint8_t val) {
	...
	i2cAcquireBus(&I2CD3);
	i2cMasterTransmitTimeout(&I2CD3, STMPE811_ADDR, txbuf, 2, 0, 0, TIME_MS2I(STMPE811_TIMEOUT));
	i2cReleaseBus(&I2CD3);
}
...
static uint8_t read_byte(GMouse* m, uint8_t reg) {
	...
	i2cAcquireBus(&I2CD3);
	i2cMasterTransmitTimeout(&I2CD3, STMPE811_ADDR, &reg, 1, rxbuf, 1, TIME_MS2I(STMPE811_TIMEOUT));
	i2cReleaseBus(&I2CD3);
...
static uint16_t read_word(GMouse* m, uint8_t reg) {
	...
	i2cAcquireBus(&I2CD3);
	i2cMasterTransmitTimeout(&I2CD3, STMPE811_ADDR, &reg, 1, rxbuf, 2, TIME_MS2I(STMPE811_TIMEOUT));
	i2cReleaseBus(&I2CD3);
